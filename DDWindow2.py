...
"color: rgb(255, 255, 255);")
        self.PS_Instructions.setScaledContents(False)
        ...
        self.buttonENTER.setGeometry(QtCore.QRect(270, 352, 157, 78))
        font = QtGui.QFont()
        font.setFamily("Swiss 911 Compressed")
        font.setPointSize(36)
        font.setBold(True)
    ...
    def retranslateUi(self, DDWindow):
        ...
        self.AS_DecoLabel3.setText(_translate("DDWindow", "The wager must be at least $5 and no more than $."))
        ...
        self.buttonENTER.setText(_translate("DDWindow", "ENTER"))
