...
import pandas as pd
import random
from ClueWindow3 import Ui_ClueWindow
...
class Ui_MainWindow(object):
    def initPlayAgain(self):
           ...
           self.AS_InstructionsLabel.setText("Player" + str(mostRecentCorrect) + " to select a clue")
           index = 0
    ...
    def showClueWindow(self, category, clue, amount, dailyDouble, DDplayer=0):
         ...
         if(dailyDouble == "yes"):
               ...
               self.showDDWindow(category = category, clue=clue, amount=amount, dailyDouble=dailyDouble, DDplayer="")
                ...
                self.ClueWindowui.correctButton.setVisible(True)
                self.ClueWindowui.incorrectButton.setVisible(True)
                #no point in showing indicators for Daily Doubles
                self.ClueWindowui.ReadyIndicatorL.setVisible(False)
                self.ClueWindowui.ReadyIndicatorR.setVisible(False)
                self.ClueWindowui.AlexReadyIndicatorL.setVisible(False)
                self.ClueWindowui.AlexReadyIndicatorR.setVisible(False)
...
#TODO: when Incorrect() is called it shouldn't automatically close the window bc others have a chance to guess
    ...
    def setupUi(self, BaseWindow):
        ...
        BaseWindow.resize(1824, 600)
        BaseWindow.setStyleSheet("background-color: rgb(0, 0, 0);")
...
"")
        ...
        self.AS_InstructionsLabel = QtWidgets.QLabel(self.centralwidget)
        self.AS_InstructionsLabel.setGeometry(QtCore.QRect(1094, 10, 660, 50))
        font = QtGui.QFont()
        font.setFamily("ITC Korinna Bold")
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.AS_InstructionsLabel.setFont(font)
        self.AS_InstructionsLabel.setStyleSheet("background-color: #060CE9;\n"
"color: rgb(255, 255, 255);")
        self.AS_InstructionsLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.AS_InstructionsLabel.setObjectName("AS_InstructionsLabel")
        ...
        self.AS_InstructionsLabel.raise_()
...
###########################################################################################################
    ...
    def retranslateUi(self, BaseWindow):
        ...
        self.PS_P1Name.setText(_translate("BaseWindow", "Player1"))
        self.PS_P1Money.setText(_translate("BaseWindow", "$0"))
        self.PS_P2Name.setText(_translate("BaseWindow", "Player2"))
        self.PS_P3Name.setText(_translate("BaseWindow", "Player3"))
        self.PS_P4Name.setText(_translate("BaseWindow", "Player4"))
        self.PS_P5Name.setText(_translate("BaseWindow", "Player5"))
        self.PS_P2Money.setText(_translate("BaseWindow", "$0"))
        self.PS_P3Money.setText(_translate("BaseWindow", "$0"))
        self.PS_P4Money.setText(_translate("BaseWindow", "$0"))
        self.PS_P5Money.setText(_translate("BaseWindow", "$0"))
        self.Cat1Clue1B.setText(_translate("BaseWindow", "$200"))
        self.Cat3Clue1B.setText(_translate("BaseWindow", "$200"))
        self.Cat4Clue1B.setText(_translate("BaseWindow", "$200"))
        self.Cat5Clue1B.setText(_translate("BaseWindow", "$200"))
        self.Cat6Clue1B.setText(_translate("BaseWindow", "$200"))
        self.Cat1Clue2B.setText(_translate("BaseWindow", "$400"))
        self.Cat1Clue3B.setText(_translate("BaseWindow", "$600"))
        self.Cat1Clue4B.setText(_translate("BaseWindow", "$800"))
        self.Cat1Clue5B.setText(_translate("BaseWindow", "$1000"))
        self.Cat2Clue2B.setText(_translate("BaseWindow", "$400"))
        self.Cat5Clue2B.setText(_translate("BaseWindow", "$400"))
        self.Cat4Clue2B.setText(_translate("BaseWindow", "$400"))
        self.Cat3Clue2B.setText(_translate("BaseWindow", "$400"))
        self.Cat2Clue3B.setText(_translate("BaseWindow", "$600"))
        self.Cat3Clue3B.setText(_translate("BaseWindow", "$600"))
        self.Cat4Clue3B.setText(_translate("BaseWindow", "$600"))
        self.Cat6Clue3B.setText(_translate("BaseWindow", "$600"))
        self.Cat5Clue3B.setText(_translate("BaseWindow", "$600"))
        self.Cat2Clue4B.setText(_translate("BaseWindow", "$800"))
        self.Cat5Clue4B.setText(_translate("BaseWindow", "$800"))
        self.Cat4Clue4B.setText(_translate("BaseWindow", "$800"))
        self.Cat3Clue4B.setText(_translate("BaseWindow", "$800"))
        self.Cat6Clue4B.setText(_translate("BaseWindow", "$800"))
        self.Cat4Clue5B.setText(_translate("BaseWindow", "$1000"))
        self.Cat5Clue5B.setText(_translate("BaseWindow", "$1000"))
        self.Cat6Clue5B.setText(_translate("BaseWindow", "$1000"))
        self.Cat3Clue5B.setText(_translate("BaseWindow", "$1000"))
        self.Cat2Clue5B.setText(_translate("BaseWindow", "$1000"))
        self.Cat6Clue2B.setText(_translate("BaseWindow", "$400"))
        self.CloseButton.setText(_translate("BaseWindow", "X"))
        self.AS_P5Name.setText(_translate("BaseWindow", "Player5"))
        self.AS_P4Name.setText(_translate("BaseWindow", "Player4"))
        self.AS_P3Name.setText(_translate("BaseWindow", "Player3"))
        self.AS_P2Name.setText(_translate("BaseWindow", "Player2"))
        self.AS_P1Name.setText(_translate("BaseWindow", "Player1"))
        self.AS_P5Money.setText(_translate("BaseWindow", "$0"))
        self.AS_P4Money.setText(_translate("BaseWindow", "$0"))
        self.AS_P3Money.setText(_translate("BaseWindow", "$0"))
        self.AS_P2Money.setText(_translate("BaseWindow", "$0"))
        self.AS_P1Money.setText(_translate("BaseWindow", "$0"))
        self.CatLabel1.setText(_translate("BaseWindow", "Cat1"))
        self.CatLabel2.setText(_translate("BaseWindow", "Cat2"))
        self.CatLabel3.setText(_translate("BaseWindow", "Cat3"))
        self.CatLabel4.setText(_translate("BaseWindow", "Cat4"))
        self.CatLabel5.setText(_translate("BaseWindow", "Cat5"))
        self.CatLabel6.setText(_translate("BaseWindow", "Cat6"))
        self.Cat2Clue1B.setText(_translate("BaseWindow", "$200"))
        self.AS_InstructionsLabel.setText(_translate("BaseWindow", "Player1 to select a clue"))
...
if __name__ == "__main__":
    ...
    BaseWindow.setWindowFlag(Qt.FramelessWindowHint)
    BaseWindow.show()
    ui.setCategories()
    sys.exit(app.exec_())
