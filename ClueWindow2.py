...
# Form implementation generated from reading ui file 'ClueWindowWidget.ui'
#
...
"color: rgb(255, 255, 255);")
        ...
        self.ReadyIndicatorWidgetL = QtWidgets.QWidget(self.centralwidget)
        self.ReadyIndicatorWidgetL.setGeometry(QtCore.QRect(0, 0, 20, 600))
        self.ReadyIndicatorWidgetL.setObjectName("ReadyIndicatorWidgetL")
        self.ReadyIndicatorWidgetR = QtWidgets.QWidget(self.centralwidget)
        self.ReadyIndicatorWidgetR.setGeometry(QtCore.QRect(1004, 0, 20, 600))
        self.ReadyIndicatorWidgetR.setObjectName("ReadyIndicatorWidgetR")
        ...
        self.ReadyIndicatorWidgetL.raise_()
        self.ReadyIndicatorWidgetR.raise_()
        ...
        self.correctButton.clicked.connect(self.changeColor)
